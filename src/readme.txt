...
If you are not happy with MuNeCo, you can uninstall it without getting into troubles with your site. The Network will work on, just without connections.


== Installation ==

Installing MuNeCo is as simple as using it.

1. Upload `MuNeCo` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in the Network-Adminscreen
